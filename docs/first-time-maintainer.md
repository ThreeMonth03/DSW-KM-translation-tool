...
5. When changing behavior, find the thin CLI script in [`src/*.py`][src-root],
   then follow it into [`src/dsw_knowledge_model_translation_tool/`][package-dir] for the
...
- [`src/dsw_knowledge_model_translation_tool/workflow.py`][workflow-py]
- [`src/dsw_knowledge_model_translation_tool/tree.py`][tree-py]
- [`src/dsw_knowledge_model_translation_tool/sync.py`][sync-py]
- [`src/dsw_knowledge_model_translation_tool/knowledge_model_service.py`][knowledge-model-service-py]
...
- [`src/dsw_knowledge_model_translation_tool/shared_blocks.py`][shared-blocks-py]
...
- [`src/dsw_knowledge_model_translation_tool/localize_sync.py`][localize-sync-py]
- [`src/dsw_knowledge_model_translation_tool/localize_merge.py`][localize-merge-py]
- [`src/dsw_knowledge_model_translation_tool/repository_ci_sync.py`][repository-ci-sync-py]
- [`src/dsw_knowledge_model_translation_tool/ci_sync.py`][ci-sync-py]
...
- [`src/dsw_knowledge_model_translation_tool/translation_repository_config.py`][translation-repository-config-py]
...
- [`src/dsw_knowledge_model_translation_tool/km_registry.py`][km-registry-py]
- [`src/dsw_knowledge_model_translation_tool/km_bundle_sync.py`][km-bundle-sync-py]
- [`src/dsw_knowledge_model_translation_tool/km_latest_sync.py`][km-latest-sync-py]
...
[examples-github-actions]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/tree/master/examples/github-actions
...
[sync-shared-strings-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/src/sync_shared_strings.py
[test-ci-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_ci_sync.py
[test-cli-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_cli_sync.py
[test-github-workflows-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_github_workflows.py
[test-km-bundle-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_km_bundle_sync.py
[test-km-latest-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_km_latest_sync.py
[test-km-registry-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_km_registry.py
[test-localize-merge-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_localize_merge.py
[test-localize-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_localize_sync.py
[test-shared-string-sync-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/translation/test_shared_string_sync.py
[test-translation-repository-config-py]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/blob/master/tests/infra/test_translation_repository_config.py
[tests-translation]: https://github.com/ThreeMonth03/DSW-knowledge-model-translation-tool/tree/master/tests/translation
